object FrmIngresoProductos: TFrmIngresoProductos
  Left = 245
  Top = 219
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Ingreso y/o modificaci'#243'n producto'
  ClientHeight = 256
  ClientWidth = 721
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 307
      Height = 18
      Caption = 'INGRESO Y/O MODIFICACI'#211'N PRODUCTO'
      Font.Charset = DEFAULT_CHARSET
  ...
  object QryConsecutivo: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT*FROM CONSECUTIVOS where CODIGO_CONSEC = '#39'PRD'#39)
    Left = 544
    Top = 8
